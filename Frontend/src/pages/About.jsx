      ...
      <div className="my-16 flex gap-20">
        ...
        <div className="w-1/2 mt-8 md:mt-0">
          ...
          <p className="text-gray-600 mb-6">
            Welcome to Prescripto, your trusted online healthcare companion. In today's fast-paced world, we understand the challenges individuals face when trying to schedule doctor appointments and managing their health records.
          </p>
          <p className="text-gray-600 mb-6">
